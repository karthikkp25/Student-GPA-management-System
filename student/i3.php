...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $insertSQL = "INSERT INTO Branch (student_id, branch_id, branch_name) 
                  VALUES ('$studentID', '$branchID', '$branchName')";
...
<body>
    ...
    <form method="post" action="<?php echo $_SERVER["PHP_SELF"]; ?>">
        ...
        <button type="submit">Enroll Branch</button>
    </form>

    <div class="redirect-btn">
        <a href="c.php">Branch Details</a>
    </div>
</body>
</html>
